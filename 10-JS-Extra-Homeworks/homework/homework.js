...
function asAmirror(str) {
  ...
  let reversa = str.split(' ').map(function (palabra) {
...
function sortArray(arr) {
  ...
  var newArray = arr.sort(function(elementoActual,elementeSiguiente){
    return elementoActual.length - elementeSiguiente.length;
  })
